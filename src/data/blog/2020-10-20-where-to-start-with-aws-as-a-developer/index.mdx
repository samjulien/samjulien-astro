...
import awsCloudShare from './images/aws-cloud-share.jpg';

<div class="rounded bg-blue-50 dark:bg-blue-900/30 px-3 py-1 dark:text-gray-100">
  Hi! <span role="img" aria-label="wave emoji">👋</span> This article has been turned into a talk! Check out{' '}
  <a
    href="https://speakerdeck.com/samjulien/where-to-start-with-aws-as-a-developer"
    target="_blank"
    rel="noopener noreferrer"
    class="text-brand hover:text-brand-dark"
  >the latest version of the slides</a>. <span role="img" aria-label="tada emoji">🎉</span>
</div>
...
<Image src={awsCloudShare} alt="AWS Public Cloud Share graph by Statista" width="600" />
