...
AI isn't just another tech hype cycle--it's decades of research finally reaching practical application, as Andrew Ng emphasizes in his talk ["Opportunities in AI"](https://www.youtube.com/watch?v=5p248yoa3oE). The stakes are incredibly high, with billionaires like Sam Altman, Mark Zuckerberg, and Elon Musk racing toward Artificial General Intelligence (AGI) -- machines as capable as humans at most tasks -- at nearly any cost. This pursuit could either transcend or endanger humanity, with ethical considerations around regulation, privacy, and security that can't be ignored.

This started as an academic pursuit, but as we've inched our way closer in recent years, billionaires have taken notice and are staking their claim, racing for more power and money. Many of these major players have stated that they will sacrifice nearly anything in pursuit of this, citing the prediction that AGI will unlock trillions of dollars of value in the global economy as justification for everything from cutting ethical corners to raising billions in capital. The main ones to be aware of are:
...
There are massive ethical and safety considerations here, such as how we should or should not regulate the development of AI technology, how we must evolve privacy and security in this new era, how we should or should not police AI-generated "deepfake" content, and much more. AGI could represent an opportunity for either the transcendance of humanity or its extinction.

It's not an exaggeration to say that this is an "all of the marbles" scenario for humanity, and it's massively important that we approach it with care. If we're not careful, an unprecedented concentration of power could happen within our lifetimes. It's my goal to contribute to the spread of this knowledge and empower as many kind, good-hearted, ethically-driven developers around the world to make a difference in their own communit and quickly add to the growing list of major players in this space.

Meanwhile, the definition of work is already changing dramatically. Tasks that once took days now take minutes. At Writer, I've seen companies automate content creation that previously required whole departments. The scale of what's possible for individual developers has fundamentally shifted, redefining what we can accomplish.

Will AI replace developers? That's certainly the stated goal of several companies. But having worked directly with enterprise AI tools, I can tell you we're in the middle of a transformation rather than a replacement. We might not need developers to build UIs before long, but we'll absolutely need people who can orchestrate AI agents, review AI-generated code, and design complex systems.

In this article, I'll break down practical strategies for getting started with AI engineering. As always, this is based on my experience - take what works for you and adapt it to your needs!

## Strategies for shifting into AI engineering

The good news is that there is currently not enough engineering talent to usher in this new era. Companies seem to be over-correcting for remote work during COVID and only wanting to hire in San Francisco and New York, but this isn't sustainable.

Here are five strategies to transition from traditional software or web development into AI engineering:

1. Stay current by ignoring the hype and following the signal
2. Use AI products to prototype and learn the fundamentals of interacting with LLMs
3. Learn the key skills for AI engineering by building with APIs and SDKs
4. Cross the divide into production AI engineering
5. Embark on advanced "side quests" as you can

### Strategy 1: Stay current by ignoring the hype and following the signal
...
Understanding these battles helps you see where the opportunities lie for developers. Here are three reliable sources of signal:
...
### Strategy 2: Use AI products to prototype and learn the fundamentals of interacting with LLMs
...
The first step is understanding how to interact with LLMs through effective prompting. This means learning to give clear instructions, provide context, and understand how different inputs affect outputs. Resources like [Sarah's prompting guide](https://exaai.notion.site/Prompt-Engineering-Best-Practices-0839585d4bce4c6abb0b551b2107a92a) and the [Instructor prompt design site](https://python.useinstructor.com/prompting/thought_generation/chain_of_thought_zero_shot/thread_of_thought/) offer excellent starting points.
...
### Strategy 3: Learn the key skills for AI engineering by building with APIs and SDKs
...
Start by learning to use the Python or TypeScript SDKs for major providers like OpenAI, Anthropic, or Hugging Face. These let you integrate AI capabilities directly into your applications.
...
#### Function calling and structured I/O
...
### Strategy 4: Cross the divide into production AI engineering
...
### Strategy 5: Embark on advanced "side quests" as you can
