...
Amidst all of the hype of AI right now, it's important to understand the game being played around you: the pursuit of Artificial General Intelligence (AGI), sometimes referred to as Artificial Superintelligence (ASI). To oversimplify, AGI or ASI is when machines become as capable or more capable than human beings at most tasks.
...
### Principle 3: The definition of work and the scale of possibility are already fundamentally changing
...
Once you're familiar with the basics of prompting, bringing in data or other modalities to LLMs, and the extent of LLM capabilities, it's time to start building with AI through APIs and SDKs. You'll want to learn a core set of essential skills, as they represent the evolution of backend engineering and likely most of web development.
...
To really dig deep into these concepts and prepare for production-level AI engineering, check out Shawn and Noah's Level Up course and Chip Huyen's book [AI Engineering]().
