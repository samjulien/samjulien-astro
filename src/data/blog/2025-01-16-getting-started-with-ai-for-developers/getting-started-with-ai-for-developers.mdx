...
### Principle 4: Traditional development work will evolve, not disappear
...
### Strategy 1: Learn the fundamentals of interacting with LLMs
...
Web search is an introduction to tool calling.

Deep Research is an introduction to agents.
...
Essential, the evolution of backend engineering and likely most of web development.
The most immediate opportunity for web developers isn't necessarily in building models - it's in combining existing AI tools effectively. I see successful AI engineers spending more time on:
...
Python
Though many tools now offer JavaScript/TypeScript SDKs, you will inevitably need to learn Python. I've been learning Python gradually as needed, using AI tools themselves to help with the transition.
...
I highly recommend checking out [DeepLearning.AI's short courses](https://www.deeplearning.ai/short-courses/), which provide an excellent foundation in these concepts.


Move on to practical implementation with Scrimba's AI Engineering path
